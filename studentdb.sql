...
INSERT INTO `cauhoidiendang` VALUES (56,'Hôm nay trường có lễ không ạ....','abc54','2023-10-05 18:27'),(57,'Sự khác biệt giữa phần mềm và ứng dụng web?','abc56','2023-10-05 18:27');
...
CREATE TABLE `giangvien` (
  `idGiangVien` varchar(50) NOT NULL AUTO_INCREMENT,
  ...
  `idTaiKhoan` varchar(50) DEFAULT NULL,
...
INSERT INTO `giangvien` VALUES ('abc19','Dương Hữu Thành','1990-03-07',1,'huuthanh@gmail.com','37/46 Phan Văn Trị, P12, Gò Vấp','0377221375','abc54'),('abc20','Phan Thị Dương','1985-11-12',0,'duong@gmail.com','450 Lê ai, Tân Kỳ, Tân Phú','0255715246',NULL),('abc21','Phạm Hoàng Thiên Ân','1995-07-09',0,'thienan@gmail.com','235 Gò Dầu, Tân Quý, tân Phú','0776655789','abc62'),('abc22','Phạm Hoàng Gia Khang','1989-03-04',1,'giakhoang@gmail.com','205 Năm Kỳ Khởi Nghĩa, P5, Quận 3','0724556785','abc55');
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `giaovu` (
  `idGiaoVu` varchar(50) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `giaovu` VALUES ('abc4','Phạm Hoàng Ân',1,'0397769522','abc52'),('abc5','Phan Yến Vi',0,'0377765521','abc53');
...
CREATE TABLE `loaitaikhoan` (
  ...
  `tenloaitaikhoan` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `monhoc_hocky` (
  ...
  `idGiangVien` varchar(50) DEFAULT NULL,
...
INSERT INTO `monhoc_hocky` VALUES (28,30,3,80,'2024-01-30 00:00:00','2024-04-30 00:00:00','abc19',1,78),(29,31,3,80,'2024-01-30 00:00:00','2024-04-30 00:00:00','abc19',1,80),(46,32,4,80,'2023-10-18 00:00:00','2023-01-20 00:00:00','abc19',2,73),(47,33,4,80,'2023-10-18 00:00:00','2024-01-20 00:00:00','abc19',2,73),(48,34,4,80,'2023-10-18 00:00:00','2024-01-20 00:00:00','abc19',2,80),(49,36,4,80,'2023-10-18 00:00:00','2024-01-20 00:00:00','abc19',3,80),(50,32,5,80,'2023-10-18 00:00:00','2024-01-20 00:00:00','abc19',4,80),(51,33,5,80,'2023-10-18 00:00:00','2024-01-20 00:00:00','abc19',5,80),(52,34,5,80,'2023-10-18 00:00:00','2024-01-20 00:00:00','abc19',6,80),(53,36,5,80,'2023-10-18 00:00:00','2024-01-20 00:00:00','abc19',7,80),(54,32,3,80,'2024-01-30 00:00:00','2024-04-30 00:00:00','abc19',8,80),(55,33,3,80,'2024-01-30 00:00:00','2024-04-30 00:00:00','abc19',1,80),(56,34,3,80,'2024-01-30 00:00:00','2024-04-30 00:00:00','abc19',2,80);
...
INSERT INTO `monhocdangky` VALUES (55,46,'abc52','Giỏi',0,0,1),(56,46,'abc53','Giỏi',0,0,1),(57,46,'abc54','Giỏi',0,0,1),(58,46,'abc55','Giỏi',0,0,1),(59,46,'abc59','Giỏi',0,0,1),(60,46,'abc57','Giỏi',0,0,1),(61,46,'abc58','Giỏi',0,0,1),(62,47,'abc52','Giỏi',0,0,1),(63,47,'abc53','Giỏi',0,0,1),(64,47,'abc54','Giỏi',0,0,1),(65,47,'abc55','Giỏi',0,0,1),(66,47,'abc59','Giỏi',0,0,1),(67,47,'abc57','Giỏi',0,0,1),(73,28,'abc52',NULL,0,0,1);
...
CREATE TABLE `sinhvien` (
  `idSinhVien` varchar(50) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `sinhvien` VALUES ('abc52','Nguyễn Thanh Thuyền','2002-04-22','200/14 Gò Dầu, Tân Quý, Tân Phú',1,'0371251727',9,'thanhthuyen@ou.edu.vn','abc56'),('abc53','Lê Anh Khoa','2002-03-21','37 Lê Thánh Tông, P11, Tân Bình',1,'0277650217',9,'cua2432002@gmail.com','abc63'),('abc54','Phan Quế Thanh','2002-03-05','41 Tân Hải, P13, Tân Bình',0,'0722451702',9,'quethanh@ou.edu.vn',NULL),('abc55','Phan Anh Thư','2002-04-06','31 Lê Lai, p14, Gò Vấp',0,'0211745022',9,'anhthu@ou.edu.vn',NULL),('abc57','Phan Thanh Hải','2002-04-06','41 Tân Hải, P13, Tân Bình',1,'0123456789',9,'thanhhai@ou.edu.vn',NULL),('abc58','Nguyễn Hải Ninh','2002-03-21','37 Lê Thánh Tông, P11, Tân Bình',1,'1234565678',10,'haininh@ou.edu.vn',NULL),('abc59','Lâm Thi Hạnh','2002-03-05','200/14 Gò Dầu, Tân Quý, Tân Phú',0,'0124711246',10,'thihanh@ou.edu.vn',NULL),('abc60','Nguyễn Mỹ Chi','2002-03-05','37 Lê Thánh Tông, P11, Tân Bình',0,'2725241359',10,'mychi@ou.edu.vn',NULL),('abc61','Hàn Thanh Lâm','2002-03-05','31 Lê Lai, p14, Gò Vấp',1,'7112583146',10,'thanhlam@ou.edu.vn',NULL),('abc62','Tăng Thị Mỹ','2002-03-05','41 Tân Hải, P13, Tân Bình',0,'7120311245',10,'thimy@ou.edu.vn',NULL);
...
CREATE TABLE `taikhoan` (
  `idTaiKhoan` varchar(50) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `taikhoan` VALUES ('abc52','hoangan2432002@gmail.com','$2y$06$qELmOrioZqbIrVfFih6IL.AbeWu4MqI8oPI55essINeY.ciHTEuTC',1,NULL),('abc53','yenvi@gmail.com','$2y$06$qELmOrioZqbIrVfFih6IL.AbeWu4MqI8oPI55essINeY.ciHTEuTC',1,NULL),('abc54','huuthanh@gmail.com','$2y$06$qELmOrioZqbIrVfFih6IL.AbeWu4MqI8oPI55essINeY.ciHTEuTC',2,'https://res.cloudinary.com/dhcvsbuew/image/upload/v1697104804/ihv6h8jxle6xhnvtchuv.jpg'),('abc55','giakhoang@gmail.com','$2y$06$qELmOrioZqbIrVfFih6IL.AbeWu4MqI8oPI55essINeY.ciHTEuTC',2,NULL),('abc56','thanhthuyen@ou.edu.vn','$2a$10$9JiiyH.N9GUBSVd4ktk4M.ideQWERB2BdwwLEoFMfVhyVXJheh4e2',3,'https://res.cloudinary.com/dhcvsbuew/image/upload/v1697662181/kyxsf60npwxl8dltsw2h.jpg'),('abc62','cua24032002@gmail.com','$2a$10$fm8.Bcgo9ynH3/p47haieOBDba0i6iVym2gORZZVSdS0PbpOdqDWG',2,NULL),('abc63','cua2432002@gmail.com','$2a$10$LANgJxLQbkcE8onbjuZYeuf.e.5tT001TBgVp9Fv53poGlk5iUuei',3,NULL);
...
INSERT INTO `traloidiendan` VALUES (34,'Có TOD nha bạn.','abc54',56);
